    ...
    try {
        ...
        if (!notification) {
            ...
            notification.stattus
                ...
                : notification === null || notification === void 0 ? void 0 : notification.stattus;
        }
...
node_cron_1.default.schedule("0 0 0 * * *", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield notification_Model_1.default.deleteMany({ stattus: "read", createdAt: { $lt: thirtyDaysAgo } });
