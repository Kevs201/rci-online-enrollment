export const styles = {
    ...
    button: "flex flex-row justify-center items-center py-3 px-3 rounded-[12px] cursor-pointer bg-[#4B0082] min-h-[45px] w-full text-[16px] font-Poppins font-semibold"
}